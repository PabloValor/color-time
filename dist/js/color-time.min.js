...
document.addEventListener("DOMContentLoaded",function(){!function(){this.ColorTime=function(){this.init=function(){var e=document.getElementById("hours"),n=document.getElementById("minutes"),t=document.getElementById("seconds");setInterval(function(){var o=new Date,i=o.getHours(),d=o.getMinutes(),r=o.getSeconds();i=10>i?"0"+i:i,d=10>d?"0"+d:d,r=10>r?"0"+r:r,e.innerHTML=i,n.innerHTML=d,t.innerHTML=r,document.body.style.backgroundColor="#"+i+d+r},1e3)}}}();var e=new ColorTime;e.init(),modals.init(),console.log("ready!")});