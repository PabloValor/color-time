...
document.addEventListener("DOMContentLoaded",function(){!function(){this.ColorTime=function(){this.init=function(){var n=document.getElementById("hours"),e=document.getElementById("minutes"),t=document.getElementById("seconds");setInterval(function(){var o=new Date,i=o.getHours(),d=o.getMinutes(),u=o.getSeconds(),c="";n.innerHTML="# "+(10>i?"0"+i:i),e.innerHTML=10>d?"0"+d:d,t.innerHTML=10>u?"0"+u:u,c=(10>i?"0"+i:i)+(10>d?"0"+d:d)+(10>u?"0"+u:u),document.body.style.backgroundColor="#"+c,console.log(document.body.style.backgroundColor)},1e3)}}}();var n=new ColorTime;n.init(),modals.init()});